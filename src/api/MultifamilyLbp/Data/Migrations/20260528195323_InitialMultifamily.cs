...
{
    /// <inheritdoc />
    public partial class InitialMultifamily : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NormalizationCaches", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobEntities_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NormalizationSuggestions_JobEntities_JobEntityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReportSnapshots_JobEntities_JobEntityId",
                        column: x => x.JobEntityId,
                        principalTable: "JobEntities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UploadBatches_JobEntities_JobEntityId",
                        column: x => x.JobEntityId,
                        principalTable: "JobEntities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InspectionRows_JobEntities_JobEntityId",
                        column: x => x.JobEntityId,
                        principalTable: "JobEntities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InspectionRows_UploadBatches_UploadBatchId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InspectionRows_JobEntityId",
                table: "InspectionRows",
                column: "JobEntityId");

            migrationBuilder.CreateIndex(
                name: "IX_InspectionRows_JobEntityId_ReadingId",
                table: "InspectionRows",
                columns: new[] { "JobEntityId", "ReadingId" });

            migrationBuilder.CreateIndex(
                name: "IX_InspectionRows_UploadBatchId",
                table: "InspectionRows",
                column: "UploadBatchId");

            migrationBuilder.CreateIndex(
                name: "IX_JobEntities_JobId_EntitySlug",
                table: "JobEntities",
                columns: new[] { "JobId", "EntitySlug" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Jobs_JobIdentifier",
                table: "Jobs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReportSnapshots_JobEntityId",
                table: "ReportSnapshots",
                column: "JobEntityId");

            migrationBuilder.CreateIndex(
                name: "IX_UploadBatches_JobEntityId",
                table: "UploadBatches",
                column: "JobEntityId");
        }
