...
public static class IntranetMap
{
    ...
    [
        ...
        new(
            "chat",
            "Chat",
            ["chatgpt", "knowledge", "kb", "rag", "conversation", "company chatgpt", "knowledge base", "documents", "prompts", "project", "new chat"],
            "/knowledge",
            ["/knowledge"],
            "From Home, open the Chat card. Click New project if you do not have one yet, then New chat. Projects have Chats, Files, and Prompts tabs.",
            "Company ChatGPT / knowledge-base RAG. Create a project, start a chat, upload files, and save prompts. Answers use project documents. Local Ollama is used when the GPU VM is up; otherwise a hosted OpenAI-compatible model when KnowledgeBase Fallback is configured. This is not the floating Help panel.",
            ["home", "help", "requests"],
            [
                "Where is Chat?",
            ...
            ["Postgres knowledge DB (pgvector)", "uploaded project files", "Ollama and/or hosted OpenAI-compatible chat"],
            "Every ETC employee. Separate from Help — Help only knows the intranet map.",
            "Open Chat from Home (the ChatGPT / knowledge-base card). Create a project with New project if you do not have one, then click New chat. Use Files to upload documents and Prompts to save reusable instructions. Chat is for company documents and Q&A — not this Help guide."),
        new(
            "lead",
            "Lead",
        ...
        new(
            ...
            "Help is this side panel (the floating Help button), not Chat. It only knows the intranet map: Home, Chat, Lead, Sales, Bids, Pipeline, Feature Requests, and sign-in. Chat is the knowledge-base ChatGPT under the Chat card on Home."),
        new(
            "signin",
            "Sign in",
