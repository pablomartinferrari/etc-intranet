...
import { EntityLandingPage } from "@mf/pages/EntityLandingPage";
...
import { GroupedReadingsPage } from "@mf/pages/GroupedReadingsPage";
  ...
  return (
    <>
      ...
      <Route path="/jobs/:jobId/:entitySlug" element={<EntityShellLayout />}>
        ...
        <Route path="grid/groups" element={<GroupedReadingsPage />} />
